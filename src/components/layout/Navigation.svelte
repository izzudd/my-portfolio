...
<div
  class="text-sm lg:text-base z-50 navigation sticky top-0 left-0 lg:w-64 h-screen py-4 lg:py-8 flex flex-col items-center lg:items-start lg:justify-between"
>
  ...
  >
    <a href="/alter" class="alter block relative py-2">
      <div class="absolute w-5/6 left-1/2 -translate-x-1/2 h-px bg-outline top-1/2" />
      <div class="text relative whitespace-nowrap w-fit px-4 bg-background left-0">Alter Ego</div>
      <div class="back-filter absolute bottom-0 w-0 h-full backdrop-invert" />
    </a>
  </div>
